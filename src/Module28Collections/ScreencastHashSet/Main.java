package Module28Collections.ScreencastHashSet;
/*
in this program I am trying a HashSet class which eliminates the creation of duplicates in its collection
 */
import java.util.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (Car car: carSet) System.out.println(car);
    }
}
